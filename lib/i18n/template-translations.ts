...
const TEMPLATE_DESC: Record<string, Record<LangCode, string>> = {
    ...
    synthetic_edu: {
        ...
        hi: 'Focused on explaining and educating about the synthetics market. Ideal to capture new traders.',
        fr: 'Axée sur l\'explication et l\'éducation sur le marché des synthétiques. Idéal pour capter de nouveaux traders.',
        ar: 'مركّزة على شرح وتثقيف حول سوق الأصول الصناعية. مثالية لجذب متداولين جدد.',
        bn: 'Focused on explaining and educating about the synthetics market. Ideal to capture new traders.',
        pt: 'Focada em explicar e educar sobre o mercado de sintéticos. Ideal para captar novos traders.',
        ru: 'Фокус на объяснении и обучении рынку синтетиков. Идеально для привлечения новых трейдеров.',
        ja: 'シンセティクス市場の説明と教育に特化。新規トレーダーの獲得に最適。',
    },
    propfirm_pro: {
        ...
        hi: 'High conversion landing for PropFirm challenges (Obsidian, Basalt, Elite, Ultra).',
        fr: 'Landing à haute conversion pour les défis PropFirm (Obsidian, Basalt, Elite, Ultra).',
        ar: 'صفحة تحويل عالية لتحديات PropFirm (Obsidian, Basalt, Elite, Ultra).',
        bn: 'High conversion landing for PropFirm challenges (Obsidian, Basalt, Elite, Ultra).',
        pt: 'Landing de alta conversão para os desafios PropFirm (Obsidian, Basalt, Elite, Ultra).',
        ru: 'Лендинг с высокой конверсией для челленджей PropFirm (Obsidian, Basalt, Elite, Ultra).',
        ja: 'PropFirmチャレンジ（Obsidian, Basalt, Elite, Ultra）向けの高コンバージョンLP。',
    },
    unified_copy_mam: {
        ...
        hi: 'Dual landing explaining both MAM system and Copy Trading with comparison tables.',
        fr: 'Landing double expliquant à la fois le système MAM et le Copy Trading avec des tableaux comparatifs.',
        ar: 'صفحة مزدوجة تشرح نظام MAM ونسخ التداول مع جداول مقارنة.',
        bn: 'Dual landing explaining both MAM system and Copy Trading with comparison tables.',
        pt: 'Landing dual que explica tanto o sistema MAM quanto o Copy Trading com tabelas comparativas.',
        ru: 'Двойной лендинг, объясняющий систему MAM и копитрейдинг с таблицами сравнения.',
        ja: 'MAMシステムとコピートレードの両方を比較表で解説するデュアルLP。',
    },
    pro_leverage_x12: {
        ...
        hi: 'Specialized in x12 leverage accounts without evaluation. No time limits.',
        fr: 'Spécialisée dans les comptes à levier x12 sans évaluation. Sans limite de temps.',
        ar: 'متخصصة في حسابات الرافعة المالية x12 بدون تقييم. بدون حدود زمنية.',
        bn: 'Specialized in x12 leverage accounts without evaluation. No time limits.',
        pt: 'Especializada em contas com alavancagem x12 sem avaliação. Sem limites de tempo.',
        ru: 'Специализируется на счетах с плечом x12 без оценки. Без ограничений по времени.',
        ja: '評価なしのx12レバレッジアカウントに特化。時間制限なし。',
    },
    institutional_mother: {
        ...
        hi: 'The main corporate landing for Bridge Markets with all services integrated.',
        fr: 'La landing principale d\'entreprise de Bridge Markets avec tous les services intégrés.',
        ar: 'الصفحة المؤسسية الرئيسية لـ Bridge Markets مع جميع الخدمات المتكاملة.',
        bn: 'The main corporate landing for Bridge Markets with all services integrated.',
        pt: 'A landing principal corporativa da Bridge Markets com todos os serviços integrados.',
        ru: 'Основной корпоративный лендинг Bridge Markets со всеми интегрированными сервисами.',
        ja: 'すべてのサービスを統合したBridge Marketsの主要コーポレートLP。',
    },
    synthetic_universe_total: {
        ...
        hi: 'Premium landing showcasing the complete ecosystem: Deriv + Weltrade + Bridge Markets.',
        fr: 'Landing premium présentant l\'écosystème complet : Deriv + Weltrade + Bridge Markets.',
        ar: 'صفحة بريميوم تعرض النظام البيئي الكامل: Deriv + Weltrade + Bridge Markets.',
        bn: 'Premium landing showcasing the complete ecosystem: Deriv + Weltrade + Bridge Markets.',
        pt: 'Landing premium mostrando o ecossistema completo: Deriv + Weltrade + Bridge Markets.',
        ru: 'Премиум-лендинг, демонстрирующий полную экосистему: Deriv + Weltrade + Bridge Markets.',
        ja: 'Deriv + Weltrade + Bridge Marketsの完全なエコシステムを紹介するプレミアムLP。',
    },
    propfirm_sinteticos_premium: {
        es: 'Diseño ultra-premium optimizado para retos de fondeo en índices sintéticos. Alta conversión y estética Cyber Purple.',
        en: 'Ultra-premium design optimized for synthetic indices funding challenges. High conversion and Cyber Purple aesthetic.',
        zh: '针对合成指数融资挑战优化的超优质设计。高转化率和网络紫审美。',
        hi: 'Ultra-premium design optimized for synthetic indices funding challenges. High conversion and Cyber Purple aesthetic.',
        fr: 'Design ultra-premium optimisé pour les défis de financement sur indices synthétiques. Haute conversion et esthétique Cyber Purple.',
        ar: 'تصميم فائق الجودة محسن لتحديات التمويل في المؤشرات الصناعية. تحويل عالٍ وجمالية Cyber Purple.',
        bn: 'Ultra-premium design optimized for synthetic indices funding challenges. High conversion and Cyber Purple aesthetic.',
        pt: 'Design ultra-premium otimizado para desafios de financiamento em índices sintéticos. Alta conversão e estética Cyber Purple.',
