        ...
        <div className="flex h-screen w-screen font-sans overflow-hidden bg-white items-center justify-center">
            <div className="w-full max-w-[420px] px-8">
                ...
                <div className="flex items-center gap-2 mb-6">
                    ...
                    <span className="text-xs font-semibold text-[#865BFF] uppercase tracking-wider">Recuperar Acceso</span>
                </div>
                ...
                {!sent ? (
                    <>
                        ...
                        <button
                            ...
                            className="mt-5 w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg text-sm font-bold text-slate-600 bg-slate-50 border border-slate-200 hover:bg-slate-100 transition-all"
                        >
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-sm font-bold text-[#865BFF] bg-[#865BFF]/5 border border-[#865BFF]/15 rounded-lg px-4 py-2 mb-6 font-mono">
                            {email}
                        </p>
                        ...
                        <button
                            onClick={() => router.push('/login')}
                            className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-lg text-sm font-bold text-slate-700 bg-slate-50 border border-slate-200 hover:bg-slate-100 transition-all"
                        >
                            <ArrowLeft className="w-4 h-4" />
                            Volver al inicio de sesión
                        </button>
                ...
                <p className="text-center text-[11px] text-slate-400 mt-6">
                    ...
                    <a href="mailto:soporte@bridge.com" className="font-semibold text-[#865BFF] hover:text-[#6b3fd6]">
                        soporte@bridge.com
                    </a>
                </p>
            </div>
