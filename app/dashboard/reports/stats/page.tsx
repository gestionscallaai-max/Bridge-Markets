...
export default function ReportsStatsPage() {
    ...
    useEffect(() => {
        async function fetchData() {
            ...
            // Simulated chart data based on totals (could be replaced with real grouped queries)
    ...
    const metrics = [
        { label: 'Clics Totales', value: stats.clicks, icon: MousePointerClick, color: '#865BFF', trend: '+12%', isUp: true },
        { label: 'Leads Captados', value: stats.leads, icon: Users, color: '#FF5B86', trend: '+5%', isUp: true },
        { label: 'Tasa Conv.', value: stats.conversionRate, icon: Activity, color: '#10B981', trend: '-2%', isUp: false },
        ...
        <div className="space-y-8 pb-20 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 px-2">
                <div>
                    ...
                    <p className="text-slate-500 font-medium mt-1">Monitorea el crecimiento y efectividad de tus campañas en tiempo real.</p>
                </div>
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">+500 Traders Activos</span>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-[#0d0221] rounded-[3rem] p-10 text-white shadow-2xl relative overflow-hidden flex flex-col min-h-[450px]">
                    ...
                    <div className="relative z-10 flex items-center justify-between mb-10">
                        <div>
                            ...
                            <p className="text-white/40 text-xs mt-1">Distribución de impactos y captaciones en los últimos 7 días.</p>
                        </div>
                        <div className="flex items-center gap-4 bg-white/5 rounded-xl p-1 border border-white/10">
                            <button className="px-4 py-1.5 rounded-lg text-[10px] font-bold uppercase tracking-wider bg-[#865BFF]">Semana</button>
                            <button className="px-4 py-1.5 rounded-lg text-[10px] font-bold uppercase tracking-wider text-white/40 hover:text-white transition-colors">Mes</button>
                        </div>
                    </div>
                ...
                <div className="space-y-8">
                    <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm relative overflow-hidden group">
                        <div className="relative z-10">
                            <h4 className="text-sm font-black text-slate-800 uppercase tracking-widest mb-6 flex items-center gap-2">
                                <Zap className="w-4 h-4 text-amber-500" /> Rendimiento Pro
                            </h4>
                            <div className="space-y-6">
                                <div>
                                    <div className="flex justify-between text-xs font-bold mb-2 uppercase tracking-tighter">
                                        <span className="text-slate-400">Objetivo Mensual</span>
                                    ...
                                    <div className="w-full h-3 bg-slate-50 rounded-full overflow-hidden border border-slate-100 p-0.5">
                                        <motion.div 
                                            initial={{ width: 0 }}
                                            animate={{ width: `${Math.min(stats.leads, 100)}%` }}
                                ...
                                <div className="pt-4 grid grid-cols-2 gap-4">
                                    ...
                                    <div className="text-center p-4 bg-slate-50 rounded-2xl border border-slate-100">
                                        <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Alcance</div>
                    ...
                    <div className="bg-gradient-to-br from-[#865BFF] to-[#6335f8] rounded-[2.5rem] p-8 text-white shadow-xl shadow-[#865BFF]/20 relative overflow-hidden group cursor-pointer">
                        ...
                        <h4 className="text-xl font-black mb-2 relative z-10 leading-tight">¿Quieres mejorar tus números?</h4>
                        <p className="text-white/70 text-xs font-medium mb-6 relative z-10">Accede a nuestra academia premium para partners y descubre nuevas estrategias.</p>
                        <button className="bg-white text-[#865BFF] px-6 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-xl group-hover:translate-x-2 transition-all relative z-10">Ir a Academia</button>
                    </div>
                </div>
            </div>
        </div>
